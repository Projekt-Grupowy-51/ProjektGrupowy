...
const VideoGrid = ({
                       videos, videoStreamUrls = {}, videoRefs, onTimeUpdate, onLoadedMetadata = () => {
    }, videoHeight = 300, fillSpace = false, displayMode = 'auto'
                   }) => {
                ...
                {videosToShow.map((video, index) => (
                    <div key={video.id || index} className="video-container">
                        <div
                            ...
                            style={{
                                paddingTop: '56.25%', // force 16:9 ratio
                                backgroundColor: '#000',
                                borderRadius: '4px',
                                overflow: 'hidden'
                            }}
                        >
                            ...
                            {/* overlays stay inside container */}
                            {video.title && (
                                <div
