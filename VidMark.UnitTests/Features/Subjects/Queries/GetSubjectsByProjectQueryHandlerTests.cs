...
public class GetSubjectsByProjectQueryHandlerTests
{
    private readonly ISubjectRepository _subjectRepository;
    private readonly ICurrentUserService _currentUserService;
    private readonly IAuthorizationService _authorizationService;
    private readonly GetSubjectsByProjectQueryHandler _handler;

    public GetSubjectsByProjectQueryHandlerTests()
    {
        _subjectRepository = Substitute.For<ISubjectRepository>();
        _currentUserService = Substitute.For<ICurrentUserService>();
        _authorizationService = Substitute.For<IAuthorizationService>();
        _handler = new GetSubjectsByProjectQueryHandler(_subjectRepository, _currentUserService, _authorizationService);
    }
    ...
    public async Task Handle_SubjectsExist_ReturnsSubjects()
    {
        ...
        var query = new GetSubjectsByProjectQuery(projectId, userId, false);

        _subjectRepository.GetSubjectsByProjectAsync(projectId, userId, false)
