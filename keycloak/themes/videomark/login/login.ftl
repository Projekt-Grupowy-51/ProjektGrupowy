...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <main id="kc-content" class="videomark-content">
      <div id="kc-form">
        <div id="kc-form-wrapper">
          <#if realm.password>
              <form id="kc-form-login" class="videomark-form" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                  <#if !usernameHidden??>
                      <div class="${properties.kcFormGroupClass!} form-group">
                          ...
                          <#if messagesPerField.existsError('username','password')>
                              <span id="input-error" class="${properties.kcInputErrorMessageClass!} kc-feedback-text" aria-live="polite">
                  ...
                  <div class="${properties.kcFormGroupClass!} form-group">
                      ...
                      <input tabindex="2" id="password" class="${properties.kcInputClass!} form-control" name="password"
                  ...
                  <div id="kc-form-buttons" class="${properties.kcFormGroupClass!}">
                      ...
                      <input tabindex="4" class="${properties.kcButtonClass!} btn-primary" name="login" id="kc-login" type="submit" value="${msg("doLogIn")}"/>
                  </div>
              </form>
          </#if>
        </div>
    ...
    <#elseif section = "info" >
        <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
            <section id="kc-registration-container">
    ...
    <#elseif section = "socialProviders" >
        <#if realm.password && social.providers??>
            <section id="kc-social-providers" class="${properties.kcFormSocialAccountSectionClass!}">
                <hr/>
