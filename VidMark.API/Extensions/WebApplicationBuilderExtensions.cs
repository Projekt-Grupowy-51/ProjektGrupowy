...
public static class WebApplicationBuilderExtensions
{
    public static WebApplicationBuilder ConfigureServices(this WebApplicationBuilder builder, IConfiguration configuration)
    {
        ...
        var labels = new[]
        {
            new LokiLabel { Key = "app", Value = "VidMark" },
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            .Enrich.WithProperty("app", "VidMark.API")
            .Enrich.WithProperty("env", envName)
            .WriteTo.Console()
            .WriteTo.File("Logs/vidmark.log", rollingInterval: RollingInterval.Day)
