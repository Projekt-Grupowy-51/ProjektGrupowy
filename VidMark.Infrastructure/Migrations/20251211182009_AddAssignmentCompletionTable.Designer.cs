...
namespace VidMark.Infrastructure.Migrations
{
    ...
    [Migration("20251211182009_AddAssignmentCompletionTable")]
    partial class AddAssignmentCompletionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VidMark.Domain.Models.GeneratedReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VidMark.Domain.Models.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VidMark.Domain.Models.ProjectAccessCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VidMark.Domain.Models.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VidMark.Domain.Models.SubjectVideoGroupAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VidMark.Domain.Models.VideoGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VidMark.Domain.Models.AssignedLabel", b =>
                {
                    ...
                    b.HasOne("VidMark.Domain.Models.Label", "Label")
                    ...
                    b.HasOne("VidMark.Domain.Models.Video", "Video")
                        .WithMany("AssignedLabels")
            ...
            modelBuilder.Entity("VidMark.Domain.Models.GeneratedReport", b =>
                {
                    ...
                    b.HasOne("VidMark.Domain.Models.Project", "Project")
            ...
            modelBuilder.Entity("VidMark.Domain.Models.Label", b =>
                {
                    ...
                    b.HasOne("VidMark.Domain.Models.Subject", "Subject")
                        .WithMany("Labels")
            ...
            modelBuilder.Entity("VidMark.Domain.Models.SubjectVideoGroupAssignment", b =>
                {
                    ...
                    b.HasOne("VidMark.Domain.Models.VideoGroup", "VideoGroup")
                        .WithMany("SubjectVideoGroupAssignments")
